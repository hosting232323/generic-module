...
import IconTextCustom from '@/components/customs/IconText';
import AdvantagesDefaultCustom from '@/components/customs/AdvantagesDefault';
...
const componentMap = {
  ...
  brandlist: BrandList,
  advantages: {
    default: AdvantagesDefaultCustom,
